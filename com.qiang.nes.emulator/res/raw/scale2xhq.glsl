...

{
    ...
    _dx = vec2(_x, 0.00000000E+000);

    _dy = vec2(0.00000000E+000, _y);
...

{
    ...
    _TMP20 = dot(_a0085, vec3( 1.00000000E+000, 1.00000000E+000, 1.00000000E+000));

    _lc1 = -2.50000000E-001/(1.19999997E-001*_TMP20 + 2.50000000E-001);

    _a0087 = _TMP3.xyz + _TMP5.xyz + _c11;

    _TMP21 = dot(_a0087, vec3( 1.00000000E+000, 1.00000000E+000, 1.00000000E+000));
    ...
    _x0093 = _lc1*_TMP23 + 3.24999988E-001;

    _TMP30 = min(2.50000000E-001, _x0093);

    _TMP92 = max(-5.00000007E-002, _TMP30);
    ...
    _x0103 = _lc2*_TMP25 + 3.24999988E-001;

    _TMP30 = min(2.50000000E-001, _x0103);

    _TMP102 = max(-5.00000007E-002, _TMP30);
    ...
    _x0113 = _lc1*_TMP27 + 3.24999988E-001;

    _TMP30 = min(2.50000000E-001, _x0113);

    _TMP112 = max(-5.00000007E-002, _TMP30);
    ...
    _x0123 = _lc2*_TMP29 + 3.24999988E-001;

    _TMP30 = min(2.50000000E-001, _x0123);

    _TMP122 = max(-5.00000007E-002, _TMP30);

    _TMP39 = _TMP92*_TMP1.xyz + _TMP102*_TMP5.xyz + _TMP112*_TMP7.xyz + _TMP122*_TMP3.xyz + ((((1.00000000E+000 - _TMP92) - _TMP102) - _TMP112) - _TMP122)*_c11;

    _ret_0 = vec4(_TMP39.x, _TMP39.y, _TMP39.z, 1.00000000E+000);

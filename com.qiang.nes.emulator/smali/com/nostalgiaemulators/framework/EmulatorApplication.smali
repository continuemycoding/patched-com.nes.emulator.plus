...
.super Lcom/qiang/framework/MyApplication;
...
.method public onCreate()V
    ...
    .prologue
    .line 24
    invoke-super {p0}, Lcom/qiang/framework/MyApplication;->onCreate()V
    ...
    invoke-static {v0}, Lcom/nostalgiaemulators/framework/utils/Log;->setDebugMode(Z)V

    .line 27
    invoke-direct {p0}, Lcom/nostalgiaemulators/framework/EmulatorApplication;->initVersionCodes()V

    .line 29
    invoke-static {p0}, Lcom/db/android/api/AdSystem;->getInstance(Landroid/app/Application;)Lcom/db/android/api/AdSystem;

    move-result-object v0

    const-string v1, "DANGBEIAD_APPID"

    invoke-static {v1}, Lcom/qiang/framework/helpers/MetaDataHelper;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "DANGBEIAD_APPKEY"

    invoke-static {v2}, Lcom/qiang/framework/helpers/MetaDataHelper;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/db/android/api/AdSystem;->init(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/db/android/api/AdSystem;->setLogState(Z)V

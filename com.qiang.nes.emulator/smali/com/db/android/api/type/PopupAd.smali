.class public Lcom/db/android/api/type/PopupAd;
...
.method private constructor <init>(Landroid/app/Activity;)V
    ...
    iput v0, p0, Lcom/db/android/api/type/PopupAd;->showTime:I

    const/4 v0, 0x2

    invoke-virtual {p0, v0}, Lcom/db/android/api/type/PopupAd;->setmModel(I)V
...
.method public getDataFromNet()V
    ...
    iget-object v1, p0, Lcom/db/android/api/type/PopupAd;->mContext:Landroid/app/Activity;
    ...
    new-instance v3, Lcom/db/android/api/type/PopupAd$3;

    invoke-direct {v3, p0}, Lcom/db/android/api/type/PopupAd$3;-><init>(Lcom/db/android/api/type/PopupAd;)V
...
.method public getFromLoc()V
    ...
    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mContext:Landroid/app/Activity;
    ...
    iput-wide v4, p0, Lcom/db/android/api/type/PopupAd;->openTime:J

    invoke-virtual {v3}, Lcom/db/android/api/entity/InfoEntity;->getAdType()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/db/android/api/type/PopupAd;->initView(I)V

    iget-object v4, p0, Lcom/db/android/api/type/PopupAd;->mAdView:Lcom/db/android/api/view/BaseAdView;
    ...
    iput-object v0, p0, Lcom/db/android/api/type/PopupAd;->adId:Ljava/lang/String;

    invoke-virtual {v3}, Lcom/db/android/api/entity/InfoEntity;->getAdMediaUrls()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/db/android/api/type/PopupAd;->mAdmediaurl:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/db/android/api/type/PopupAd;->urls:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->urls:Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/db/android/api/type/PopupAd;->loadData()V
    ...
    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mHandler:Landroid/os/Handler;

    invoke-virtual {v0, v8}, Landroid/os/Handler;->sendEmptyMessage(I)Z

    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mListener:Lcom/db/android/api/listener/AdListener;
    ...
    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mAdView:Lcom/db/android/api/view/BaseAdView;
...
.method public handleCmd(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lcom/db/android/api/type/PopupAd;->mAdView:Lcom/db/android/api/view/BaseAdView;
    ...
    iget-object v2, p0, Lcom/db/android/api/type/PopupAd;->adId:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/db/android/api/q;->f(Ljava/lang/String;)Lcom/db/android/api/entity/InfoEntity;

    move-result-object v1

    iget-boolean v2, p0, Lcom/db/android/api/type/PopupAd;->isShowing:Z
    ...
    iget-object v1, p0, Lcom/db/android/api/type/PopupAd;->mHandler:Landroid/os/Handler;
    ...
    iput-boolean v3, p0, Lcom/db/android/api/type/PopupAd;->isShowing:Z
    ...
    iget-boolean v0, p0, Lcom/db/android/api/type/PopupAd;->isAutoRemove:Z

    if-eqz v0, :cond_3

    invoke-virtual {p0}, Lcom/db/android/api/type/PopupAd;->onClear()V
    ...
    invoke-virtual {p0}, Lcom/db/android/api/type/PopupAd;->postDataToNet()V
    ...
    iget-object v2, p0, Lcom/db/android/api/type/PopupAd;->mListener:Lcom/db/android/api/listener/AdListener;
...
.method public initView(I)V
    ...
    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mViewParent:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/db/android/api/type/PopupAd;->mViewParent:Landroid/view/ViewGroup;
    ...
    new-instance v1, Lcom/db/android/api/type/PopupAd$2;

    invoke-direct {v1, p0}, Lcom/db/android/api/type/PopupAd$2;-><init>(Lcom/db/android/api/type/PopupAd;)V
...
.method public loadData()V
    ...
    iget-object v1, p0, Lcom/db/android/api/type/PopupAd;->adId:Ljava/lang/String;
    ...
    new-instance v4, Lcom/db/android/api/type/PopupAd$1;

    invoke-direct {v4, p0, v1}, Lcom/db/android/api/type/PopupAd$1;-><init>(Lcom/db/android/api/type/PopupAd;Lcom/db/android/api/entity/InfoEntity;)V
    ...
    iget-boolean v0, p0, Lcom/db/android/api/type/PopupAd;->isShowing:Z
    ...
    iput-wide v0, p0, Lcom/db/android/api/type/PopupAd;->openTime:J

    iget-object v0, p0, Lcom/db/android/api/type/PopupAd;->mHandler:Landroid/os/Handler;

    iget v1, p0, Lcom/db/android/api/type/PopupAd;->showTime:I
...
.method public onClear()V
    ...
    iput-object v2, p0, Lcom/db/android/api/type/PopupAd;->mAdView:Lcom/db/android/api/view/BaseAdView;
...
.method public open()V
    ...
    invoke-virtual {p0, v0}, Lcom/db/android/api/type/PopupAd;->open(Z)V
...
.method public open(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, Lcom/db/android/api/type/PopupAd;->isAutoRemove:Z

    invoke-virtual {p0}, Lcom/db/android/api/type/PopupAd;->getFromLoc()V

    invoke-virtual {p0}, Lcom/db/android/api/type/PopupAd;->getDataFromNet()V
    :try_end_0
...
.method public postDataToNet()V
    ...
    new-instance v4, Lcom/db/android/api/type/PopupAd$4;

    invoke-direct {v4, p0, v1}, Lcom/db/android/api/type/PopupAd$4;-><init>(Lcom/db/android/api/type/PopupAd;Lcom/db/android/api/entity/InfoEntity;)V

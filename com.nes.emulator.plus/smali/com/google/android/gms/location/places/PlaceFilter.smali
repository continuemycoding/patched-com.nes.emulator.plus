...
.method constructor <init>(ILjava/util/List;ZLjava/util/List;Ljava/util/List;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMt:Ljava/util/List;

    iput-boolean p3, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMH:Z
    ...
    :goto_1
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMw:Ljava/util/List;
    ...
    :goto_2
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMv:Ljava/util/List;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMt:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzu(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMu:Ljava/util/Set;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMw:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzu(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMy:Ljava/util/Set;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMv:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzu(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMx:Ljava/util/Set;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMH:Z

    iget-boolean v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMH:Z
    ...
    iget-object v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMx:Ljava/util/Set;
...
.method public isRestrictedToPlacesOpenNow()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzaMH:Z

...
.method public onGameMenuPrepare(Lcom/nostalgiaemulators/framework/base/GameMenu;)V
    ...
    .line 45
    invoke-super {p0, p1}, Lcom/nostalgiaemulators/framework/base/EmulatorActivity;->onGameMenuPrepare(Lcom/nostalgiaemulators/framework/base/GameMenu;)V

    .line 46
    sget v4, Lcom/nostalgiaemulators/nes1/R$string;->game_menu_fds_eject_disk:I

    invoke-virtual {p1, v4}, Lcom/nostalgiaemulators/framework/base/GameMenu;->add(I)Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;

    .line 47
    sget v4, Lcom/nostalgiaemulators/nes1/R$string;->game_menu_fds_insert_disk:I

    invoke-virtual {p1, v4}, Lcom/nostalgiaemulators/framework/base/GameMenu;->add(I)Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;

    .line 48
    sget v4, Lcom/nostalgiaemulators/nes1/R$string;->game_menu_fds_switch_side:I

    invoke-virtual {p1, v4}, Lcom/nostalgiaemulators/framework/base/GameMenu;->add(I)Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;

    .line 50
    iget-object v4, p0, Lcom/nostalgiaemulators/nes1/NesEmulatorActivity;->game:Lcom/nostalgiaemulators/framework/ui/gamegallery/GameDescription;

    iget-object v4, v4, Lcom/nostalgiaemulators/framework/ui/gamegallery/GameDescription;->name:Ljava/lang/String;
    ...
    invoke-virtual {p1, v4}, Lcom/nostalgiaemulators/framework/base/GameMenu;->getItem(I)Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;

    move-result-object v4

    invoke-virtual {v4, v0}, Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;->setVisible(Z)V
    ...
    .line 54
    invoke-virtual {p0}, Lcom/nostalgiaemulators/nes1/NesEmulatorActivity;->isDiskInserted()Z

    move-result v5

    .line 53
    invoke-virtual {v4, v5}, Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;->setEnable(Z)V
    ...
    .line 57
    invoke-virtual {p0}, Lcom/nostalgiaemulators/nes1/NesEmulatorActivity;->isDiskEjected()Z
    ...
    .line 60
    .local v1, "switchSideItem":Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;
    invoke-virtual {v1, v0}, Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;->setVisible(Z)V
    ...
    invoke-virtual {p0}, Lcom/nostalgiaemulators/nes1/NesEmulatorActivity;->getTotalSides()I
    ...
    :goto_1
    invoke-virtual {v1, v2}, Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;->setEnable(Z)V

    .line 62
    return-void

    .end local v0    # "isFds":Z
    .end local v1    # "switchSideItem":Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;
    :cond_0
    move v0, v3
    ...
    .restart local v0    # "isFds":Z
    .restart local v1    # "switchSideItem":Lcom/nostalgiaemulators/framework/base/GameMenu$GameMenuItem;
    :cond_1
    move v2, v3
